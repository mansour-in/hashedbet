...
export class MiniGameIndex extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tokenValue: [],
  ...
  sendToken() {
    ...
    var results = fetch('http://localhost:5000/api/v1/assignTokenToUser',{
      method: "PUT",
      headers: {
        'Accept': 'application/json',
...
MiniGameIndex.propTypes = {
};

export default connect(mapStateToProps)(MiniGameIndex);
